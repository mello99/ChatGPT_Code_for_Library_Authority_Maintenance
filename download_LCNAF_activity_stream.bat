REM ===Created with ChatGPT 5.0, Edited with CodexGPT ===
@echo off
setlocal enableextensions enabledelayedexpansion

REM === CONFIGURATION ===
set "url=https://id.loc.gov/authorities/names/activitystreams/feed/1"
set "output_folder=C:\Scripts\YourFolder\LCNAF_Activity_Streams"
